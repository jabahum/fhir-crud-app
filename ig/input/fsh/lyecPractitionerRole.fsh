Profile:        LyecPractitionerRole
Parent:         PractitionerRole
Id:             lyec-practitioner-role
Title:          "Lyec Practitioner Role"
Description:    "Lyec profile of Practitioner Role."
...
* code 1..1 MS
* code ^label = "Job"
* code from http://lyecdevelopers.com/fhir/ValueSet/lyec-job
* code.coding 1..1 MS
...
* location only Reference(LyecJurisdiction)